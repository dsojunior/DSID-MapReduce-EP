...
public class StatisticsGUI extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        comoVariaiveis.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "TEMP - Temperatura média do dia", "YEAR - Ano", "MONTH - Mês", "DAY - Dia", "DEWP - Ponto médio de condensação da água", "SLP - Pressão ao nível do mar", "STP - Pressão Atmosférica", "VISIB - Visibilidade", "WDSP - Velocidade média do vento", "MXSPD - Velocidade máxima do vento", "GUST - Ruptura máxima do vento", "MAX - Temperatura máxima do dia", "MIN - Temperatura mínima do dia", "PRCP - Precipitação", "SNDP - Profundidade da neve" }));
        ...
        comboAgrupar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Y - Ano", "M - Mês", "MY - Mês/Ano", "W - Dia da Semana", "C - País", "S - Estação" }));
    ...
    private void btnExecutarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExecutarActionPerformed
        ...
        //Remover a aba do gráfico, se ela existir
        if(this.painelAbas.getComponentCount()==2)
        ...
        try
        {
            ...
            if(jb.waitForCompletion(true))
            {
                ...
                //Cria o grafico
                if(argumentos[3].equals("Y") || argumentos[3].equals("MY") || argumentos[3].equals("M"))
                {
                    GraphicCreator g = new GraphicCreator("", funcao, txtSaida.getText());
                    painelAbas.add("Predição de Valores", g.getPanel());
                }
            }
            else
            {
